...
export const metadata = buildMetadata({
  ...
  description:
    "Source Indian wedding outfits from India or request destination-wedding planning support for Gujarati and Hindu celebrations in Cancun, Riviera Maya, or Punta Cana.",
