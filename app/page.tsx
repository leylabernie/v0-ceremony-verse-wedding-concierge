    ...
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans antialiased">
      ...
      <header className="relative bg-gradient-to-b from-stone-100 via-white to-stone-50 py-28 px-4 sm:px-6 lg:px-8 text-center overflow-hidden border-b border-stone-200">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/contact"
              className="bg-stone-900 hover:bg-stone-800 text-amber-50 font-medium py-4 px-10 rounded-none text-sm tracking-wider uppercase transition-all shadow-sm"
            >
              Book Discovery Call
            </Link>
            <Link 
              href="/guide"
              className="bg-transparent border border-stone-900 text-stone-900 hover:bg-stone-900 hover:text-amber-50 font-medium py-4 px-10 rounded-none text-sm tracking-wider uppercase transition-all"
            >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 border border-stone-200 flex flex-col">
              ...
              <Link href="/guide" className="block text-center border border-stone-900 text-stone-900 hover:bg-stone-900 hover:text-amber-50 py-3 font-medium text-xs tracking-wider uppercase transition-colors">
                Get the Guide
              </Link>
            </div>
            ...
            <div className="bg-stone-900 p-10 border border-stone-900 flex flex-col relative shadow-xl">
              <div className="absolute top-0 right-0 bg-amber-700 text-amber-50 text-[10px] font-bold px-4 py-1.5 uppercase tracking-widest">Most Popular</div>
              <h3 className="text-2xl font-serif font-bold text-amber-50 mb-2">Sourcing Concierge</h3>
              <p className="text-4xl font-serif font-bold text-amber-50 mb-6">$599</p>
              ...
              <ul className="space-y-4 mb-10 text-stone-200 text-sm">
              ...
              <Link href="/contact" className="block text-center bg-amber-700 hover:bg-amber-800 text-amber-50 py-3 font-medium text-xs tracking-wider uppercase transition-colors">
            ...
            <div className="bg-white p-10 border border-stone-200 flex flex-col">
              ...
              <Link href="/contact" className="block text-center border border-stone-900 text-stone-900 hover:bg-stone-900 hover:text-amber-50 py-3 font-medium text-xs tracking-wider uppercase transition-colors">
                Book Free Consultation
              </Link>
            </div>
          </div>
      ...
      <footer className="bg-stone-900 text-stone-400 py-16 px-4 border-t border-stone-800">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-serif font-bold text-amber-50 mb-4 tracking-wide">CeremonyVerse</h3>
          <p className="mb-8 font-light text-sm text-stone-500">Making NRI bridal shopping safe, seamless, and stress-free.</p>
