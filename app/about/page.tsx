    ...
    <main className="min-h-screen bg-[#faf8f5] text-[#1f1f1f]">
      ...
      <section className="bg-[#1f1f1f] px-6 py-24 text-[#f8f6f2]">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-5 text-sm font-semibold uppercase tracking-[0.2em] text-[#c5a059]">
            Mini · Founder &amp; Destination Wedding Concierge
          </p>
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-[#e8dfd2] md:text-xl">
            Founded by Mini, CeremonyVerse was shaped by firsthand family-side experience navigating multi-day Indian destination
      ...
      <section className="bg-white px-6 py-20 sm:py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mx-auto mt-6 max-w-3xl space-y-5 text-lg leading-8 text-[#4d403a]">
            <p>
              Before CeremonyVerse launched, Mini coordinated custom outfits for her son&apos;s wedding. After
