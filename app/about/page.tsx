      ...
      <section className="bg-white px-6 py-20 sm:py-24">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div>
            ...
            <h2 className="font-serif text-4xl font-semibold sm:text-5xl">Destination planning across Mexico, Jamaica, and Punta Cana</h2>
            <div className="mt-6 space-y-5 text-lg leading-8 text-[#4d403a]">
              <p>CeremonyVerse supports Gujarati and Hindu destination weddings across Mexico, Jamaica, and Punta Cana. CeremonyVerse is the family-facing point of contact for cultural requirements, approvals, guest organization, logistics oversight, transparency, and optional India outfit sourcing.</p>
