...
function buildCrmRecord(lead: LeadCapture, requestId: string) {
  return {
    ...
    stage: lead.source === "calculator" ? "calculator-lead" : "chat-lead",
    ...
    nextStep: lead.source === "calculator" ? "email-results" : "follow-up",
    status: "New Lead",
    offerTag: lead.source === "calculator" ? "calculator" : "chat",
