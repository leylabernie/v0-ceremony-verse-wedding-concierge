...
export const metadata = buildMetadata({
  ...
  title: "Destination Wedding Guest Logistics Checklist",
  description:
    "Organize destination-wedding guest rooms, arrivals, transfers, dietary needs, welcome details, and missing information for Mexico or Punta Cana.",
  keywords:
    "destination wedding guest logistics checklist, Indian wedding room block tracker, wedding airport transfer list, Mexico wedding guest management",
})

const breadcrumbSchema = buildBreadcrumb([
  { name: "Planning Tools", url: "/planning-tools/" },
  { name: "Guest Logistics", url: "/planning-tools/guest-logistics/" },
])
    ...
    <main className="bg-[#faf8f5] text-[#1f1f1f]">
      ...
      <section className="px-6 py-20 text-center sm:py-24">
        <div className="mx-auto max-w-4xl">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.22em] text-[#7a6841]">Guest experience tool</p>
          <h1 className="font-serif text-4xl font-semibold sm:text-6xl">Guest Logistics Checklist</h1>
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-[#4d403a]">
            Keep guest, room, arrival, transfer, and welcome details in one controlled tracker. Collect only the information needed for the task—never passport scans, payment-card details, or unrelated personal records.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-24">
        ...
        <div className="mx-auto mt-10 flex max-w-6xl flex-col gap-3 sm:flex-row">
          <Link href="/contact/?service=mexico" className="rounded-full bg-[#7a6841] px-7 py-3 text-center text-sm font-semibold text-white">Discuss Guest Support</Link>
