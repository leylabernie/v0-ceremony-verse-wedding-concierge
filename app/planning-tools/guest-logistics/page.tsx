...
export const metadata = buildMetadata({
  ...
  description:
    "U.S. and Canadian families can calculate guest room nights, family-paid VIP rooms and flights, transfers, and welcome costs for an Indian destination wedding in Mexico, Jamaica, or Punta Cana.",
  keywords:
