...
export const metadata = buildMetadata({
  ...
  description:
    "A concise decision guide for comparing Mexico, Jamaica, and Punta Cana resort proposals for Gujarati, Hindu, and South Asian destination weddings.",
  keywords:
      ...
      <section className="bg-[#1f1f1f] px-6 py-24 text-center text-white sm:py-28">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mx-auto mt-7 max-w-4xl text-lg leading-8 !text-white/80">
            A short starting point for Gujarati, Hindu, Sikh, Punjabi, and South Asian families comparing Mexico, Jamaica, or Punta Cana destination-wedding proposals. You do not need to complete a long worksheet before you ask for help.
          </p>
