  ...
  return (
    <div style={{ background: "#f8f6f2", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "80px 24px 48px", textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
        <p style={{ fontSize: "13px", letterSpacing: "0.22em", textTransform: "uppercase", color: "#7a6841", marginBottom: "14px" }}>
            ...
            {sarees.map((saree) => (
              <div key={saree.src} style={{ borderRadius: "14px", overflow: "hidden", border: "1px solid #e6dfd5", background: "#f9f6f3" }}>
                ...
                <div style={{ padding: "16px" }}>
                  <h3 style={{ fontWeight: 600, fontSize: "15px", color: "#1f1f1f", marginBottom: "6px" }}>{saree.name}</h3>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "20px" }}>
            {[
              ...
              <div key={item.title} style={{ background: "#f9f6f3", borderRadius: "14px", padding: "24px", border: "1px solid #e6dfd5" }}>
                ...
                <p style={{ fontSize: "15px", color: "#4d403a", lineHeight: 1.6 }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
