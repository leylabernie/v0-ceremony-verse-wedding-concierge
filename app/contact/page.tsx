...
export const metadata = buildMetadata({
  path: "/contact/",
  title: "Register for a Free CeremonyVerse Wedding Consultation",
  description:
    "Register a consultation request from anywhere in the USA or Canada for India wedding sourcing, the $300 feasibility plan, or Gujarati and Hindu planning in Mexico or Punta Cana.",
});
...
const breadcrumbSchema = buildBreadcrumb([
  { name: "Register for Free Consultation", url: "/contact/" },
]);
