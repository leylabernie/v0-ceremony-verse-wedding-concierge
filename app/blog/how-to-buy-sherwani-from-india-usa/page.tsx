        ...
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.125rem", lineHeight: 1.8, color: "#2f2f2f" }}>
          ...
          <div style={{ background: "#faf8f4", border: "1px solid #e6dfd5", borderRadius: "12px", padding: "2rem", marginTop: "2.5rem" }}>
            ...
            <p style={{ fontSize: "0.9rem", color: "#4d403a", marginTop: "0.8rem" }}>
              Want help researching a sherwani? <Link href="/buy-indian-wedding-outfits-from-india/" style={{ color: "#7a6841", fontWeight: 600 }}>See how groom sourcing works</Link> — eligible live review, vendor-specific measurement coordination, written approvals, and delivery support within the selected scope.
            </p>
          </div>
