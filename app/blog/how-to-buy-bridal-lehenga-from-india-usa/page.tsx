      ...
      <article style={{ maxWidth: "760px", margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.05rem", lineHeight: 1.8, color: "#2f2f2f" }}>
          ...
          <ul style={{ marginTop: "1rem", paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            ...
            <li><strong>US customs duties:</strong> As of August 29, 2025, the US ended the de minimis exemption that previously allowed packages under $800 to enter duty-free. All shipments from India are now subject to import duties — currently at a 25% tariff rate on most textile goods. Budget accordingly</li>
          ...
          <ul style={{ paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            ...
            <li><strong>Full payment required upfront before seeing the outfit.</strong> Reputable outfit specialists will work with a deposit structure — typically 50% upfront and 50% before shipping.</li>
          ...
          <p style={{ marginTop: "1.2rem" }}>
            A US-based Indian wedding shopping concierge like <Link href="/" style={{ color: "#c7b28a" }}>CeremonyVerse</Link> offers an important layer of accountability: they are operating under US consumer protection standards, you are communicating in the same time zone, and their reputation is built on happy clients — not one-time transactions.
          </p>
          ...
          <div style={{ marginTop: "3rem", paddingTop: "1.5rem", borderTop: "1px solid #e6dfd5" }}>
            <p style={{ fontSize: "0.8rem", color: "#6f6a63", lineHeight: 1.7 }}>
              ...
              <a href="https://www.help.cbp.gov/s/article/Article-1402?language=en_US" target="_blank" rel="noopener noreferrer" style={{ color: "#6f6a63" }}>US Customs and Border Protection — Duty-Free Exemption</a>{" · "}
