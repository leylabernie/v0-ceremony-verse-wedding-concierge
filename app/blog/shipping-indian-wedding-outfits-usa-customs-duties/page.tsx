    ...
    <main style={{ background: "#f8f6f2", minHeight: "100vh" }}>
      ...
      <article style={{ maxWidth: "760px", margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.05rem", lineHeight: 1.8, color: "#2f2f2f" }}>
          ...
          <p style={{ marginTop: "1rem" }}>Duty is calculated on the <strong>declared value</strong> of the goods. A reputable shipper will prepare proper commercial invoices with accurate HTS codes and fabric descriptions. If the invoice is vague or incorrect, customs may reclassify your items at a higher rate — or hold the package for inspection, adding 1-3 weeks. For the latest rates, see our <Link href="/blog/us-tariffs-indian-wedding-outfits-2026" style={{ color: "#a69260" }}>2026 US tariffs guide</Link>.</p>
          ...
          <div style={{ background: "#fff", border: "1px solid #e6dfd5", borderRadius: "12px", padding: "1.5rem", marginTop: "2.5rem" }}>
            ...
            <ul style={{ paddingLeft: "1.2rem", fontSize: "0.95rem" }}>
              ...
              <li style={{ marginBottom: "0.4rem" }}>
                <Link href="/blog/us-tariffs-indian-wedding-outfits-2026" style={{ color: "#a69260" }}>
          ...
          <div style={{ background: "#faf8f4", border: "1px solid #e6dfd5", borderRadius: "12px", padding: "2rem", marginTop: "2.5rem" }}>
            ...
            <p style={{ fontSize: "0.9rem", color: "#6f6a63", marginTop: "0.8rem" }}>
              Don&apos;t want to deal with customs paperwork yourself? <Link href="/services" style={{ color: "#a69260", fontWeight: 600 }}>See how we handle international delivery</Link> — we prepare all documentation, insure every package, track delivery to your door.
            </p>
          </div>

          <p style={{ marginTop: "2rem", fontSize: "0.85rem", color: "#5e4a40" }}><strong>About CeremonyVerse:</strong> We source and ship Indian wedding outfits for NRI families — handling quality inspection, customs documentation, insured shipping, and delivery to your US door. <Link href="/faq" style={{ color: "#a69260" }}>Read our FAQ</Link> or <Link href="/blog/us-tariffs-indian-wedding-outfits-2026" style={{ color: "#a69260" }}>see our 2026 tariff guide</Link>.</p>
        </div>
      </article>
    </main>
  );
