    ...
    <main style={{ background: "#f8f6f2", minHeight: "100vh" }}>
      ...
      <article style={{ maxWidth: "760px", margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.05rem", lineHeight: 1.8, color: "#2f2f2f" }}>
          ...
          <p>Planning an Indian wedding in the US means coordinating outfits for 8-15+ people across 5-7 different events. Most NRI families we work with forget at least 3-4 outfits until the week before — leading to panic shopping at overpriced US boutiques. This checklist prevents that. Use it alongside our guide on <Link href="/blog/how-to-coordinate-bridesmaid-lehengas-india-usa" style={{ color: "#a69260" }}>how to order bridesmaid lehengas from India</Link> to keep your group orders on track. For ceremony-specific outfit guidance, see our dedicated pages on <Link href="/haldi-outfits-usa/" style={{ color: "#a69260" }}>Haldi outfits</Link>, <Link href="/reception-outfits-usa/" style={{ color: "#a69260" }}>Reception outfits</Link>, and <Link href="/banarasi-silk-sarees-usa/" style={{ color: "#a69260" }}>Banarasi silk sarees</Link>.</p>
          ...
          <div style={{ background: "#fff", border: "1px solid #e6dfd5", borderRadius: "12px", padding: "1.5rem", marginTop: "2.5rem" }}>
            ...
            <ul style={{ paddingLeft: "1.2rem", fontSize: "0.95rem" }}>
              ...
              <li style={{ marginBottom: "0.4rem" }}>
                <Link href="/blog/how-to-coordinate-bridesmaid-lehengas-india-usa" style={{ color: "#a69260" }}>
                  How to order bridesmaid lehengas from India for a US wedding
                </Link>
              </li>
              <li>
                <Link href="/services" style={{ color: "#a69260" }}>
          ...
          <div style={{ background: "#faf8f4", border: "1px solid #e6dfd5", borderRadius: "12px", padding: "2rem", marginTop: "2.5rem" }}>
            ...
            <p style={{ fontSize: "0.9rem", color: "#6f6a63", marginTop: "0.8rem" }}>
              Overwhelmed by the outfit count? <Link href="/contact" style={{ color: "#a69260", fontWeight: 600 }}>Book a free planning call</Link> and we&apos;ll help you build a realistic budget and timeline for your full family&apos;s wedding wardrobe — most families save $9,000-$17,000 compared to buying everything in the US.
            </p>
          </div>
