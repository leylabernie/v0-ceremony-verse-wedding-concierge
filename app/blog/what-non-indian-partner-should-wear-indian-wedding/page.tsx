    ...
    <main style={{ background: "#f8f6f2", minHeight: "100vh" }}>
      ...
      <div style={{ background: "#2f2f2f", padding: "4rem 1.5rem 3rem", textAlign: "center" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 600, color: "#f8f6f2", lineHeight: 1.25, margin: "0 0 1.5rem" }}>
            What Should a Non-Indian Partner Wear to an Indian Wedding? A Complete Guide
          </h1>
          <p style={{ color: "#c7b28a", fontSize: "0.95rem", lineHeight: 1.7 }}>
            For intercultural couples navigating the full wedding wardrobe — what works, what does not, and how CeremonyVerse helps you get it right.
          </p>
        </div>
      </div>
      ...
      <article style={{ maxWidth: "760px", margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "1.05rem", lineHeight: 1.8, color: "#2f2f2f" }}>
          ...
          <p style={{ marginTop: "1.2rem" }}>
            If the saree speaks to you strongly — if your partner&rsquo;s family has a specific saree tradition and you want to honor it fully — start practicing the drape six months in advance and work with a professional for the day itself. Do not attempt traditional saree draping alone on your wedding morning.
          </p>
          ...
          <ul style={{ marginTop: "1rem", paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            <li><strong>Get properly fitted.</strong> A custom-stitched blouse that fits your exact measurements will be infinitely more comfortable than a standard-size one. Share your measurements precisely — bust, waist, back length — and expect one round of alterations after receipt.</li>
            <li><strong>Practice walking.</strong> Wear the outfit around your home for at least an hour before the wedding. Understand how the skirt moves, how to manage the dupatta, and how wide your natural stride is in the garment.</li>
            <li><strong>Consider the weight.</strong> Heavy bridal lehengas — especially those with dense zardozi embroidery — can weigh 6–9 kilograms. This is not a problem during the ceremony, but it is something to know in advance. Lighter options exist at every price point and are worth discussing if weight is a concern.</li>
            <li><strong>Wear the right undergarments.</strong> A well-fitted lehenga requires a lehenga blouse that fits snugly. Wear the same undergarments during fittings that you plan to wear on the wedding day.</li>
          </ul>
          ...
          <p>
            Non-Indian grooms have three strong options at an Indian ceremony, ranging from fully traditional to a respectful crossover look. All three are appropriate — the right choice depends on your comfort level, your partner&rsquo;s family&rsquo;s expectations, and how the ceremony is structured.
          </p>
          ...
          <p style={{ marginTop: "1.2rem" }}>
            Sourcing a <Link href="/buy-sherwani-from-india-usa" style={{ color: "#c7b28a" }}>custom sherwani from India</Link> produces the best result for non-Indian grooms — because the garment needs to be cut to your specific measurements, and Indian grooms&rsquo; sizing charts (especially for height and shoulder width) may not correspond to your frame.
          </p>
          ...
          <p>
            These are casual, daytime events. For a non-Indian bride, a simple cotton salwar kameez or a bright anarkali set is perfect. These are informal events — the goal is to look festive and cheerful rather than formal. Yellow is the traditional color for haldi functions. For mehndi, anything bright works: coral, lime, fuchsia, turquoise. <Link href="/mehndi-outfits-usa" style={{ color: "#c7b28a" }}>Mehndi outfits</Link> are an easy, low-cost addition to the wardrobe.
          </p>
          <p style={{ marginTop: "1.2rem" }}>
            For a non-Indian groom, a simple cotton or linen kurta pajama in a matching or complementary color is entirely appropriate for mehndi and haldi. This is a low-formality event and the groom&rsquo;s outfit reflects that.
          </p>
          ...
          <p style={{ marginTop: "1.2rem" }}>
            <strong>Sizing for non-standard frames.</strong> Standard Indian bridal sizing was not designed with non-Indian body types in mind. We work with custom stitching for every non-Indian partner we dress — taking precise measurements (including height, shoulder width, and proportional measurements that Indian sizing charts often omit) and communicating those directly to artisans who tailor accordingly. Every outfit we source for a non-Indian partner is made to their specific body, not fitted to an Indian sizing standard.
          </p>
          <p style={{ marginTop: "1.2rem" }}>
            <strong>Live video verification.</strong> For intercultural couples who cannot travel to India, our live video shopping sessions let you see the actual garment — not a catalog photo — before you commit to it. You see the fabric quality, the embroidery detail, the color accuracy in real light. Non-Indian partners, who may have less visual reference for what Indian bridal quality looks like, especially benefit from this real-time view.
          </p>
          <p style={{ marginTop: "1.2rem" }}>
            <strong>Experience with real intercultural couples.</strong> We have dressed non-Indian partners for Indian weddings across the US, UK, and Canada. We know the questions that come up — whether a non-Indian bride can wear white (generally avoid it in Hindu ceremonies; it is associated with mourning), whether a non-Indian groom can wear a turban with his sherwani (absolutely, and many non-Indian grooms find it one of the most memorable parts of their experience), what to do when the partner&rsquo;s family has strong opinions about color choices. You can see some of the couples we have worked with in our <Link href="/real-weddings" style={{ color: "#c7b28a" }}>real weddings gallery</Link>.
          </p>
          <p style={{ marginTop: "1.2rem" }}>
            Our process for intercultural couples — from the initial styling consultation through the final outfit delivery — is explained in detail on our <Link href="/how-it-works" style={{ color: "#c7b28a" }}>how it works page</Link>.
          </p>
          ...
          <ul style={{ marginTop: "1rem", paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            <li><strong>Avoid white at Hindu ceremonies.</strong> White is associated with mourning in Hindu tradition. Even an ivory or cream lehenga reads differently from a stark white one — but it is worth being aware of the cultural connotation. For Christian-Hindu interfaith ceremonies, white may be entirely appropriate for the Christian portion; the key is understanding which ceremony you are dressing for.</li>
            <li><strong>Ask about family color preferences.</strong> In many Indian families, specific colors are considered auspicious for the bride or are traditionally reserved for the bride&rsquo;s side versus the groom&rsquo;s side. A quick conversation with your partner and their family about color expectations — before you finalize your outfit — avoids potential friction.</li>
            <li><strong>Expect people to notice and comment positively.</strong> Non-Indian partners in Indian clothes attract genuine warmth and appreciation at Indian weddings. Be prepared for grandparents, aunts, and family friends to come up to you specifically to say how wonderful it is that you made this effort. This is one of the most universally positive experiences intercultural couples report from their wedding days.</li>
            <li><strong>Give yourself enough lead time.</strong> Non-Indian partners need more lead time than Indian partners because custom sizing takes longer to coordinate. Plan to start sourcing the ceremony outfit at least 5–6 months before the wedding, and pre-wedding outfits at least 3 months out.</li>
          </ul>
          ...
          <div style={{ background: "#2f2f2f", borderRadius: "8px", padding: "2rem", marginTop: "2.5rem", textAlign: "center" }}>
            ...
            <p style={{ color: "#6f6a63", fontSize: "0.85rem", marginTop: "1rem" }}>
              Or see how our process works on our <Link href="/how-it-works" style={{ color: "#c7b28a" }}>how it works page</Link>.
            </p>
          </div>
