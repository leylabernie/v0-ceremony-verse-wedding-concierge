...
export const metadata = buildMetadata({
  ...
  description: "Answers about Gujarati and Hindu destination-wedding planning in Mexico, Jamaica, and Punta Cana, provider responsibilities, pricing, and optional India outfit sourcing.",
})

const faqItems = [
  { question: "Where does CeremonyVerse currently plan destination weddings?", answer: "Current destination-wedding positioning includes Mexico, Jamaica, and Punta Cana for families throughout the United States and Canada. Availability and the selected destination team are confirmed in writing." },
  ...
  { question: "Can Mexico all-inclusive resorts cook Gujarati and Hindu wedding food, or allow outside caterers?", answer: "Most resorts require food served on site to be prepared in their own kitchens, and many have successfully prepared Indian menus when full recipes, pure-vegetarian or Jain requirements, and tastings are documented early. Outside chefs and caterers are only possible where the specific resort approves them in writing. Confirm every food rule in the resort's current written event contract." },
  { question: "What hidden fees come with a multi-day Indian wedding at a Cancún resort?", answer: "Beyond the package price, plan for a private-event minimum per event, outside-vendor fees, Sangeet production and staging, setup and overtime charges, day passes for guests staying elsewhere, and taxes and service charges. Request a written, itemized estimate for every event day before signing — the resort's current written proposal controls all actual fees." },
    ...
    <main className="min-h-screen bg-[#faf8f5] text-[#1f1f1f]">
      ...
      <section className="px-6 pb-16 pt-32 text-center sm:pb-24 sm:pt-40">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mx-auto max-w-2xl text-lg leading-8 text-[#4d403a]">Clear answers about Mexico, Jamaica, and Punta Cana planning, provider responsibilities, the free consultation, public starting fees, and optional paid India outfit sourcing.</p>
        </div>
      </section>
