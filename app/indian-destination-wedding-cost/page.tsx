...
export const metadata = buildMetadata({
  ...
  description:
    "Build the complete cost of an Indian destination wedding in Mexico, Jamaica, or Punta Cana across rooms, events, vendors, planning, travel, taxes, and contingency.",
})
