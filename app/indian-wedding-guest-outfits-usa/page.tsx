...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Need Indian wedding guest outfits in the USA? CeremonyVerse sources lehengas, sarees, anarkalis, and sherwanis from India — live video shopping, custom stitching, delivered to your US door.",
    type: "website",
    url: "https://www.ceremonyverse.com/indian-wedding-guest-outfits-usa",
        ...
        <div style={{ maxWidth: "680px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gap: "16px" }}>
            {[
              ...
              { title: "How Much Does a Bridal Lehenga Cost?", desc: "Real price ranges for bridal lehengas from India, including shipping and customs.", href: "/blog/how-much-does-bridal-lehenga-from-india-cost" },
