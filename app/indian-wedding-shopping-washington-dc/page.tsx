...
export const metadata = buildMetadata({
  ...
  title: "Indian Wedding Shopping Washington DC",
  description: "DMV families can source Indian wedding outfits from India with live shopping, custom stitching, and delivery across Washington DC, Maryland, and Virginia.",
