...
export const metadata = buildMetadata({
  path: "/destinations/",
  title: "Indian Destination Weddings in Mexico, Jamaica & Punta Cana",
  description:
    "Compare Cancún, Riviera Maya, Los Cabos, Jamaica, and Punta Cana for a multi-day Gujarati or Hindu destination wedding, including guest access, room blocks, culture, costs, and execution.",
...
const destinations = [
  ...
  },
  {
    ...
    summary: "Compare resort location, airport choice, multi-event spaces, cultural and food requirements, room blocks, and written weather backups.",
    bestWhen: "The chosen resort, guest travel plan, and destination team fit the full celebration.",
  },
  {
    name: "Punta Cana",
...
const faqItems = [
  {
    ...
    answer:
      "Current destination-wedding positioning includes Mexico, Jamaica, and Punta Cana. Cancún, Riviera Maya, and Los Cabos have dedicated comparison pages, but CeremonyVerse is not limited to those areas of Mexico. Availability and the selected local team are confirmed in writing for each wedding.",
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Gujarati and Hindu Destination Wedding Planning in Mexico, Jamaica, and Punta Cana",
  description:
  ...
  areaServed: ["Mexico", "Jamaica", "Punta Cana, Dominican Republic", "United States", "Canada"],
})
      ...
      <section className="px-6 py-20 sm:py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 font-serif text-4xl font-semibold sm:text-5xl">Explore the destination guides</h2>
