      ...
      <section className="bg-white px-6 py-20 sm:py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-[#4d403a]">
            CeremonyVerse now serves Gujarati and Hindu destination weddings across Mexico, Jamaica, and Punta Cana, with
            planning, on-site coordination, family support, guest organization, and optional India sourcing defined
            privately for each wedding. Jamaica and Punta Cana are part of current service coverage, but not part of the three
