      ...
      <div className="bg-[#f9f6f3] border-t border-[#e6dfd5] py-14 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <a href="/" className="text-left mb-4 block">
              <span className="font-garamond text-xl uppercase tracking-[0.2em] font-semibold text-[#1f1f1f]">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="text-sm text-[#6a5c55] hover:text-[#c7b28a] transition"
                  >
                    {item.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: "Book Consultation", href: "https://wa.me/12153419990?text=Hi%2C%20I%27m%20interested%20in%20CeremonyVerse%20services." },
              ].map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
