    ...
    faqs: [
      {
        ...
        answer: "We believe in radical transparency. Our pricing includes: the factory cost of the garment, our sourcing and quality control fee (typically 15-20% of garment cost), shipping and customs handling, and quality guarantee coverage. We provide itemized quotes showing exactly what you're paying for. No hidden markups, no surprise fees. Most clients save 30-50% compared to US-based Indian boutiques while getting superior quality and customization.",
      },
      {
        question: "What's your payment schedule?",
        answer: "We use a milestone-based payment structure to protect both parties: 25% deposit to reserve your production slot and source fabrics, 35% after fabric approval and before production begins, 30% after final quality inspection with photos/video, and 10% upon delivery confirmation. You never pay for the next stage until you've approved the previous one.",
      },
      {
        question: "Do you accept payment plans?",
        answer: "Yes! For orders over $3,000, we offer extended payment plans that align with wedding planning timelines. We can structure payments across 4-6 months, making premium sourcing accessible without financial strain. We accept credit cards, bank transfers, and can work with most payment methods.",
      },
    ],
  },
  {
    ...
    <div className="animate-fade-in">
      ...
      <section className="bg-navy py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gold/20 text-gold text-sm font-medium rounded-full mb-6">
          ...
          {faqCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="mb-12 last:mb-0">
              <div className="mb-6">
                ...
                <p className="text-navy/60">{category.description}</p>
              </div>
              ...
              <div className="space-y-3">
                {category.faqs.map((faq, faqIndex) => {
                  ...
                  return (
                    <div
                      key={faqIndex}
                      className="glass rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200"
                    >
                      <button
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-navy/70 text-lg mb-8 max-w-2xl mx-auto">
            We're happy to address any concerns. Schedule a free consultation and let's talk 
