    ...
    <div className="bg-[var(--cv-bg)]">
      <section className="relative text-center overflow-hidden" style={{ minHeight: "380px" }}>
        ...
        <div className="relative py-24 px-6" style={{ zIndex: 2 }}>
          <p className="text-xs font-medium tracking-widest uppercase mb-4" style={{ color: "#7a6841" }}>Sacred Traditions</p>
      ...
      <section className="py-16 px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a href="https://wa.me/12153419990?text=Hello%20CeremonyVerse!%20I%20need%20ceremonial%20items%20sourced." target="_blank" rel="noopener noreferrer" className="btn-ghost">WhatsApp CeremonyVerse</a>
        </div>
      </section>
    </div>
  )
