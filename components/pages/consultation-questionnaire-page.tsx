          ...
          <details className={sectionClass}>
            ...
            <div className="mt-7 grid gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <input id="destinationIdeas" className={inputClass} value={formData.destinationIdeas} onChange={(event) => updateFormData("destinationIdeas", event.target.value)} placeholder="Mexico, Jamaica, Punta Cana, resort ideas, or not decided" />
              </div>
              <div className="sm:col-span-2">
