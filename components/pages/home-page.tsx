...
import { ImageSchema, ProductSchema } from "@/components/seo/json-ld"
...
const testimonials = [
  ...
  },
  {
    ...
    location: "USA",
    quote:
      "For our Gujarati wedding, Bhamini travelled to Kanchipuram specifically to source pure silk sarees — the real thing, not a compromise. Bhamini also had our matching outfits custom made by a local boutique to our exact vision. The attention to detail was extraordinary.",
  ...
  return (
    <main className="">
      <ImageSchema
        ...
        caption="Red and gold bridal lehenga with intricate zardozi embroidery sourced from India for NRI bride in USA by CeremonyVerse Indian wedding shopping concierge"
      />
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center mb-14">
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid #e6dfd5" }}>
            ...
            />
            <ImageSchema
              url="https://www.ceremonyverse.com/images/live-video-shopping-india.jpg"
              caption="Real bridal lehenga workshop in India — CeremonyVerse live video shopping experience for NRI brides in USA"
            />
          </div>
        </div>
                ...
                <div className="border-t border-[#e6dfd5] pt-4 flex items-center gap-3">
                  {t.photo ? (
                    <React.Fragment>
                      ...
                      />
                      <ImageSchema url={`https://www.ceremonyverse.com${t.photo}`} caption={`CeremonyVerse testimonial photo: ${t.names}`} />
                    </React.Fragment>
                  ) : (
                    <div
